...
description: >
  Create a comprehensive guideline development for a specific language document following a structured interview process.
---

# Generate Guideline Skill
...
**OBS:** For projects with existing _codebase_, and previous _documentation_, try scanning the codebase and documentation to answer the questions and fill the `<>` parameters.

1. What the _programming language_ `<lang>` the project is written in?
    - python
    - c#
    - typescript
    - go
    ...
    - rust
    - swift
    - other [Type the language name]
2. What the _orm_ `<orm>` the project is using?
    - sqlalchemy
    - django
    - other [Type the orm or database framework name]
3. What the _database_ `<db>` the project is using?
    - postgresql
    - mysql
    - sqlite
    - other [Type the database name]
4. What the _framework_ `<framework>` the project is using?
    - dotnet
    - django
    - langchain
    - spring
    ...
    - swiftui
    - other
5. What the _web framework_ `<web>` the project is using?
    - flask
    - django
    - spring
    - express
    ...
    - aspnetcore
    - other
6. What the _ai framework_ `<ai>` the project is using?
    - langchain
    - openai
    - anthropic

    - other [Type the ai framework name]
7. What the _testing framework_ `<testing>` the project is using?
    - pytest
    - unittest
    - xunit
    - mstest
    - swifttest
    - other
8. What the _logging framework_ `<logging>` the project is using?
    - logging
    - serilog
    - log4net
    - swiftlog
    - other
9. What the _http client_ `<http>` the project is using?
    - httpclient
    - httpx
    - aiohttp
    - requests
    - other
10. What the async framework `<async>` the project is using?
    - asyncio
    - tornado
    - async/await
    - other
...
1. Extact all `<>` parameters collected from the user interview questions.
2. If any parameter is not provided, prompt the user again for the missing information.
...
- Verification that specified libraries (if any) are appropriate for <lang>
...
**Write to**: `<lang>-development-guidelines.md`
...
**Append to**: `<lang>-development-guidelines.md`
...
**FINALLY**: Begin Phase 1 research for **<lang>** and specified libraries.
