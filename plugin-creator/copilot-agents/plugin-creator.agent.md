---
name: plugin-creator
description: Assistente de entrevista para criar plugins de IA multiplataforma compatíveis com Claude Code, GitHub Copilot CLI e Cursor. Coleta nome, agentes, skills e destino, depois gera a estrutura completa (manifests, agents, copilot-agents, skills, README e entradas de marketplace). Ativa para "criar plugin", "novo plugin", "plugin-creator", "scaffold plugin", "criar ai plugin", "plugin Claude", "plugin Cursor", "plugin Copilot".
