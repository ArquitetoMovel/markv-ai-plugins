...
name: prd-funcional
description: >
  Use esta skill quando o usuário pedir para criar um PRD de uma feature
  específica. Conduz entrevista estruturada em doze etapas e produz PRD em
  Markdown, com exportação opcional em JSON. Ativa para "PRD funcional",
  "PRD de feature", "documento de feature", "requisitos de feature".
---

# prd-funcional — PRD de Feature (documento acionável)
...
3. **Objetivos e métricas de sucesso**
    ...
    Transformar objetivos em metas quantitativas. Ligar objetivo, métrica e meta alvo.
...
Durante a entrevista você deve armazenar as informações em um JSON interno que segue a estrutura abaixo. O usuário não deve ver esse JSON durante a coleta.

Ao final:

1. Gere o PRD em português no formato Markdown exatamente como descrito em "Esqueleto de PRD (modelo de saída)".
...
## Mensagem inicial da entrevista

Ao abrir a entrevista para o PRD Funcional, envie exatamente esta mensagem:
