...
**Observação:** Caso esteja no repositório do projeto, tente ler os fontes e extrair as informações a partir deles.
Sugira ao usuário as respostas capturadas a partir do que foi extraido. 
Permita o usuário informar um valor diferente do que foi sugerido.
