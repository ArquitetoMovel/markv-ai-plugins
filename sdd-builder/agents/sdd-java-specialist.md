...
description: >
  Especialista Java do fluxo SDD. Recebe uma fase do `plan.md`, implementa o código conforme
  `spec.md` e `tests.md`, roda build, testes e verificação estática, e devolve o resultado ao
  `sdd-feature-builder`. Ativa para: "implementar fase em java", "código Java",
  "especialista Java", "Spring Boot", "Maven", "Gradle", "JUnit".
model: sonnet
tools:
  - Read
  - Write
