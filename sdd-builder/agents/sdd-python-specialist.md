...
description: >
  Especialista Python do fluxo SDD. Recebe uma fase do `plan.md`, implementa o código
  conforme `spec.md` e `tests.md`, roda testes, lint e type check, e devolve o resultado ao
  `sdd-feature-builder`. Ativa para: "implementar fase em python", "código Python",
  "especialista Python", "FastAPI", "Django", "pytest", "ruff", "mypy".
model: sonnet
tools:
  - Read
  - Write
