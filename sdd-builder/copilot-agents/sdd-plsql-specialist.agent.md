...
description: Especialista PL/SQL e Oracle do fluxo SDD. Recebe uma fase do `plan.md`, implementa packages, procedures e migrações conforme `spec.md` e `tests.md`, compila, roda os testes e devolve o resultado ao `sdd-feature-builder`. Ativa para: "implementar fase em plsql", "código PL/SQL", "especialista Oracle", "package Oracle", "utPLSQL", "Liquibase Oracle".
