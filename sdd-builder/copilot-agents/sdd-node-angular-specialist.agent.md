...
description: Especialista Node, Angular e TypeScript do fluxo SDD. Recebe uma fase do `plan.md`, implementa o código conforme `spec.md` e `tests.md`, roda build, testes, lint e type check, e devolve o resultado ao `sdd-feature-builder`. Ativa para: "implementar fase em node", "código TypeScript", "especialista Angular", "React", "NestJS", "Express", "vitest", "jest".
